...
namespace UiPath_RPA_JaelaCarlosama
{
    ...
    {
        private Lazy<global::UiPath_RPA_JaelaCarlosama.WorkflowRunnerService> _workflowRunnerServiceLazy;
        ...
        public CodedWorkflow()
        {
            ...
            _workflowRunnerServiceLazy = new Lazy<global::UiPath_RPA_JaelaCarlosama.WorkflowRunnerService>(() => new global::UiPath_RPA_JaelaCarlosama.WorkflowRunnerService(this.services));
#pragma warning disable
            _connectionsManagerLazy = new Lazy<ConnectionsManager>(() => new ConnectionsManager(serviceContainer));
#pragma warning restore
        }

        protected global::UiPath_RPA_JaelaCarlosama.WorkflowRunnerService workflows => _workflowRunnerServiceLazy.Value;
